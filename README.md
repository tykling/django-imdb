...
5. Run `manage.py reindex_pocketsearch`
...
Step 4+5 should be run regularly, like weekly or monthly. Data is updated daily by IMDb. Read more https://developer.imdb.com/non-commercial-datasets/
